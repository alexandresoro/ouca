import { OngoingSubStatus, OngoingValidationStats } from "../graphql";
...
export type ImportOnDemandStatusMessage = {
  type: typeof ON_DEMAND_STATUS,
  status: OngoingValidationStats
}
