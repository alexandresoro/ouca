...
const ImportSexesPanel: FunctionComponent = () => {
      ...
      <div className="overflow-x-auto">
        <table className="table table-xs table-zebra">
          ...
          <tbody>
            <tr>
              <th>A *</th>
              <td>{t("importInstructions.sexes.label.name")}</td>
              <td>{t("importInstructions.sexes.label.description")}</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default ImportSexesPanel;
