...
const ImportDepartmentsPanel: FunctionComponent = () => {
      ...
      <div className="overflow-x-auto">
        <table className="table table-xs table-zebra">
          ...
          <tbody>
            <tr>
              <th>A *</th>
              <td>{t("importInstructions.departments.code.name")}</td>
              <td>{t("importInstructions.departments.code.description")}</td>
            </tr>
          </tbody>
        </table>
      </div>
...
export default ImportDepartmentsPanel;
